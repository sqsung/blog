    ...
    <footer className="mt-auto flex flex-col items-center justify-center gap-3 py-10">
      <div className="flex items-center gap-3">
        <a
          ...
          className="text-t-subtle hover:text-t-normal transcolor cursor-pointer"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="text-t-subtle hover:text-t-normal transcolor cursor-pointer rounded-full"
        >
          <GitHubIcon />
        </a>
      </div>
